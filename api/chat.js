export default async function handler(req, res) {
  ...
  // 🚀 FALLBACK: It will look for the key with or without the REACT_APP_ prefix
  ...
  try {
    ...
    // 🚀 If Gemini rejects the key or hits a limit, it sends the exact reason to your frontend
    if (data.error) {
